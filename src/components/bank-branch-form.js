...
export default function BankBranchForm({
    ...
    return (
        <Card className="w-full max-w-3xl mx-auto min-w-[1000px]">
            <CardHeader>
                <CardTitle>
                    {initialValues.location_name ? "Update" : "Add"} Bank Branch
                    Location
                </CardTitle>
            </CardHeader>
            <Form {...form}>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex space-x-4">
                                <p>
                                    Latitude:{" "}
                                    <strong>
                                        {latitude !== null ? latitude : "N/A"}
                                    </strong>
                                </p>
                                <p>
                                    Longitude:{" "}
                                    <strong>
                                        {longitude !== null ? longitude : "N/A"}
                                    </strong>
                                </p>
                            </div>
                        </div>
