...
const Filter = ({onButtonClick}) => {
    const data = ["ATM (Tarik Tunai)", "CDM (Setor Tunai)", "TST (Tarik dan Setor Tunai)", "Main Branch (KC)", "Digital Lounge (KCP)", "Sub Branch (KCP)", "Kiosk", "Syariah Main Branch (KCS)", "Kantor Fungsional Syariah (KFS)", "Weekend Banking"];
